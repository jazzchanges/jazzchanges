...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tune.owner'
        db.add_column('tunes_tune', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tune.owner'
        db.delete_column('tunes_tune', 'owner_id')
